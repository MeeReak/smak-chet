import { NotiCardList, NotiDropdown, NotificationCard, Typography } from '@/components'
import React from 'react'

const page = () => {
  return (
    <div>
      <div className='bg-[#f0f2f5] pt-[100px] pb-[30px] flex justify-center'>
        <div className='xl:w-[855px] md:w-screen w-screen bg-white rounded-lg drop-shadow-lg p-4'>
            ...
            <div>
                <NotiCardList classname="xl:w-[706px] h-[100px]"></NotiCardList>
            </div>
        </div>
      </div>
    </div>
