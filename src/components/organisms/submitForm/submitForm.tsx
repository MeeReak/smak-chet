    ...
    <div className="space-y-4 mx-auto">
      ...
      <div className="w-[1024px] h-[140px] bg-[#F8F8F8] rounded-[10px]">
        <div className="space-y-3 py-[28px]">
          ...
          />
          {errors.name && <p className="text-[#EB5757]">{errors.name}</p>}
        </div>
      </div>
      <div className="w-[1024px] h-[140px] bg-[#F8F8F8] rounded-[10px]">
        <div className="space-y-3 py-[28px]">
          ...
          <input
            ...
            placeholder="Short Answer"
          />
          {errors.address && <p className="text-[#EB5757]">{errors.address}</p>}
        </div>
      </div>
      <div className="w-[1024px] h-[140px] bg-[#F8F8F8] rounded-[10px]">
        <div className="space-y-3 py-[28px]">
      ...
      <div className="w-[1024px] h-[140px] bg-[#F8F8F8] rounded-[10px]">
        <div className="space-y-3 py-[28px]">
          ...
          />
          {errors.phonenumber && (
            <p className="text-[#EB5757]">{errors.phonenumber}</p>
          )}
        </div>
      </div>
      <div className="w-[1024px] h-[140px] bg-[#F8F8F8] rounded-[10px]">
      ...
      <div className="w-[1024px] h-[140px] bg-[#F8F8F8] rounded-[10px]">
        <div className="space-y-3 py-[28px]">
          <Typography className="pl-4" fontSize="h4">
            Have you joined volunteer before?<span className="text-[16px] text-red-500">*</span>
          </Typography>
          <input
            onChange={(e) => handleOnChange(e)}
            name="phonenumber"
